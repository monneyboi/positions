...
above are the durable constitutional anchors. Ministries, courts, and
first-level subnational institutions extend the spine but are surveyed
aggregate-only.
...
```text
P31   position (Q4164871)   (Heads project; Q294414 also occurs — §6)
...
- legislative term `P13188` → legislature, with `P571`/`P576` and
  `P1365`/`P1366` succession;
...
- direct office type `Q294414` (every politician) vs `Q4164871`
  (Heads project);
- cabinet `P527`: persons vs offices, unresolved;
- `P1308` (position holder): office-side roster scope disputed — P39
